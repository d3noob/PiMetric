...
// Here we should be able to write our information to the database.
		...
		$sql = 	"INSERT INTO status ".
		        "(name, value, dtg, script, ".
		        "schedule, parent, priority, ".
		        "measured, monitored, ".
		        "alert_lower, caution_lower, ".
		        "normal_lower, normal_upper, ".
		        "caution_upper, alert_upper, ".
		        "level_actual, level_ack, ".
		        "help_url, description, label, acknowledged) ".
		        "VALUES (:name, :value, :dtg, ".
		        ":script, :schedule, :parent, ".
		        ":priority, :measured, :monitored, ".
		        ":alert_lower, ".
		        ":caution_lower, :normal_lower, ".
		        ":normal_upper, :caution_upper, ".
		        ":alert_upper, :level_actual, ".
		        ":level_ack, :help_url, ".
		        ":description, :label, :acknowledged)";
	...
	$error_message_name = 'Enter your new metric name';
	$name = '';
	$script = '';
	...
	header("Location: fail.php?error_message=Sorry,+original+metric+not+found.");
	exit();
}
	...
	<form class="form-horizontal" role="form" action="duplicate.php" method="post">
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-6">
			...
			<button type="submit" class="btn btn-lg btn-success" style="margin-top: 20px;">Create Duplicate Metric</button>
	    </div>
        <div class="col-sm-4 control-label" style="text-align: left">
	      <span style="font-size: 10px; color: grey "> 
